...
return array (
  ...
  'error_no_admin_user' => 'There must be at least 1 common group overseer of this group and of its sub-groups.',
  ...
  array (
    ...
    'no_admin' => 'There is no other group overseer in this group or in its sub-groups. You will be able to continue only after you have assigned this role to somebody else in every affected group.',
  ...
  array (
    'admin' => 
    array (
      'activate' => 'Do you want to enable this function?',
      'anyone' => 'All publishers in the group',
      'authorized_only' => 'Only those to whom we grant permission',
      'info' => 'If you enable this, the message board function will be available on the Home page for the relevant group. In the "Publishers" menu, you will be able to grant further access permissions to some publishers or you will be able to block them from writing messages (despite the block, they will be able to read the messages). The messages will be stored for a maximum of 7 days, then they will be deleted.',
      'priority' => 'Would you like to use the urgent message function?',
      'priority_info' => 'If you choose to allow, messages can be marked as urgent. In such cases, the group servants and those with a permission will receive an email notification about the message.',
      'who_can_write' => 'Who shall have the permission to write messages?',
    ),
    'be_short' => 'When you write a message, please be short and include only the necessary pieces of information.',
    'cant_write' => 'You cannot write messages at the moment.',
    'deleted' => 'Deleted.',
    'info' => 'The message board is available to those who have an upcoming ministry in the next 24 hours or shared in the ministry in the past 2 hours.',
    'limit' => 'Too many attempts, please wait.',
    'no_messages' => 'There are no messages.',
    'title' => 'Message board',
    'type' => 'Write a message',
    'urgent' => 'Urgent',
    'urgent_info' => 'In urgent cases, your message will also be sent to your group servant and group overseer in email. Please, use this function only if the matter is truly urgent.',
    'user' => 
    array (
      'can_write' => 'The publisher can write messages on the message board at any time',
      'cant_write' => 'The publisher is only allowed to read the messages but cannot write any',
      'catch_urgent' => 'Urgent messages shall be forwarded to him/her',
      'default' => 'When the publisher has an actual ministry',
      'title' => 'Message board settings',
      'when_use' => 'When can the publisher use the message board?',
    ),
  ),
  'min' => 'Min.',
