        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('timezone') ? ' has-error ' : '' }}">
                    <label for="timezone">
                        {{ trans('installer_messages.environment.wizard.form.app_timezone') }}
                        <sup>
                            <a href="https://www.php.net/manual/en/timezones.php" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.app_timezone_info') }}">
                                <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>
                                <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.app_timezone_info') }}</span>
                            </a>
                        </sup>
                    </label>
                    <input type="text" name="timezone" id="timezone" value="{{ ini_get('date.timezone') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_timezone_placeholder') }}" />
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('session_driver') ? ' has-error ' : '' }}">
                            <label for="session_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.session_label') }}
                                <sup>
                                    <a href="https://laravel.com/docs/8.x/session" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>
                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>
                                    </a>
                                </sup>
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('redis_hostname') ? ' has-error ' : '' }}">
                            <label for="redis_hostname">
                                ...
                                <sup>
                                    <a href="https://laravel.com/docs/8.x/redis" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>
                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>
                                    </a>
                                </sup>
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('mail_from_address') ? ' has-error ' : '' }}">
                            <label for="mail_from_address">
                                {{ trans('installer_messages.environment.wizard.form.app_tabs.mail_from_address') }}
                            </label>
                            <input type="text" name="mail_from_address" id="mail_driver" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_from_address_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                            <label for="mail_driver">
                                ...
                                <sup>
                                    <a href="https://laravel.com/docs/8.x/mail" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>
                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>
                                    </a>
                                </sup>
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                            <label for="admin_email">
                                {{ trans('installer_messages.environment.wizard.form.app_tabs.admin_email') }}
                            </label>
                            <input type="text" name="admin_email" id="admin_email" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.admin_email_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('admin_password') ? ' has-error ' : '' }}">
                            <label for="admin_password">{{ trans('installer_messages.environment.wizard.form.app_tabs.admin_password') }}</label>
                            <input type="password" name="admin_password" id="admin_password" value="" placeholder="" />
                        ...
                        <div class="form-group {{ $errors->has('admin_password') ? ' has-error ' : '' }}">
                            <label for="admin_password_confirmation">{{ trans('installer_messages.environment.wizard.form.app_tabs.admin_password_confirmation') }}</label>
                            <input type="password" name="admin_password_confirmation" id="admin_password_confirmation" value="" placeholder="" />
