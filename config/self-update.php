...
return [
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type' => 'github',
            'repository_vendor' => env('SELF_UPDATER_REPO_VENDOR', 'MDylan'),
            'repository_name' => env('SELF_UPDATER_REPO_NAME', 'JW-public-ministry-organizer-app'),
            'repository_url' => 'https://github.com/MDylan/JW-public-ministry-organizer-app',
            'download_path' => env('SELF_UPDATER_DOWNLOAD_PATH', '/tmp'),
            'private_access_token' => env('SELF_UPDATER_GITHUB_PRIVATE_ACCESS_TOKEN', ''),
            'use_branch' => env('SELF_UPDATER_USE_BRANCH', 'dev'),
        ],
        'http' => [
            'type' => 'http',
