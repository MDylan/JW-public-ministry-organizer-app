...
return array (
  ...
  'update_manual_blocked' => 'Version :version is a new major release, so it cannot be installed automatically. A manual update is required.',
  'update_manual_info' => 'This release is deliberately not installed automatically, because it is a new major version: it requires a different PHP and framework environment than the current one, which an automatic update cannot provide. The update has to be carried out manually, following the steps in the description above. Until then the installed version keeps working, and it still updates automatically within its own branch.',
  'update_manual_title' => 'A new major version is available - manual update required',
  'urgent' => 'IMPORTANT!',
